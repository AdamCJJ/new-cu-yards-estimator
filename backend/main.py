...
def version() -> JSONResponse:
    commit = os.environ.get("RENDER_GIT_COMMIT") or os.environ.get("COMMIT_SHA") or "unknown"
    env_name = os.environ.get("RENDER_ENVIRONMENT") or os.environ.get("ENVIRONMENT") or "unknown"
    return JSONResponse({"commit": commit, "environment": env_name})
